                ...
                <el-form :model="ruleForm2" :rules="rules2" ref="ruleForm2" label-position="left" label-width="0px"
                    ...
                    <el-form-item style="width:100%; margin-top: 25px">
                        <el-button type="primary"
                                   style="width:100px; float: right; background-color: #ff3825;border-color: #ff3825"
                                   @click.native.prevent="handleLogin" :loading="logining">登录
                        </el-button>
                        <el-button style="width: 100px; float: left; margin-left: 0px;"
                                   @click.native.prevent="handleReset2">注册
                        </el-button>
                    </el-form-item>
...
<script>
  ...
  export default {
    ...
    methods: {
      handleLogin() {
        this.logining = true;
        let bodys = {username: this.ruleForm2.account, password: this.ruleForm2.checkPass};
        this.$axios.admin
          .adminLogin(bodys)
          .then(response => {
